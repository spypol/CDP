...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Formation - Compote de Prod</title>
        <meta name="description" content="Compote de Prod Formation">
		...
		<!-- FONTS -->
		<link href='http://fonts.googleapis.com/css?family=Roboto+Condensed:400italic,400,300|Roboto:400,400italic,700' rel='stylesheet' type='text/css'>
...
Nos formateurs vous guideront tout au long de votre projet.
    ...
    <div class="footer-container footer-formation">
		...
		<!-------------------------- GOOGLE ANALYTICS -------------------------->
        <script>
            var _gaq=[['_setAccount','UA-42345032-1'],['_trackPageview']];

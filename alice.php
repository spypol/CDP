            ...
            <div class="main wrapper clearfix">
				...
				<div id="articles-right">
						...
						<section>
							...
							<div class="slider-wrapper theme-default gallery">
								<div id="photos-alice" class="nivoSlider">
									<a href="img/ALICE_affiche.jpg" data-lightbox-gallery="gallery-alice" class="preview-image"><img src="img/ALICE_affiche.jpg" data-thumb="img/ALICE_affiche.jpg" alt=""/></a>
								</div>
							</div>
					...
					<article id="video">
						<section>
							<h1>Vid&eacute;os</h1>
							<iframe class="playerVimeo" src="//player.vimeo.com/video/78148571?title=0&amp;byline=0&amp;portrait=0" width="650" height="400" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
						</section>
					</article>

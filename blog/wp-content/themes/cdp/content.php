	...
	<footer class="entry-footer">
		<?php if ( 'post' == get_post_type() ) : // Hide category and tag text for pages on Search ?>
			...
			<span class="cat-links">
				<?php printf( __( 'Posted in %1$s', 'cdp' ), $categories_list ); ?>
			</span>
		...
		<span class="comments-link"><?php comments_popup_link( __( 'Leave a comment', 'cdp' ), __( '1 Comment', 'cdp' ), __( '% Comments', 'cdp' ) ); ?></span>
		<?php endif; ?>

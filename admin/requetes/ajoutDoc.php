<?php
	...
	if($isLien == 0){
		...
		$target_path = $_SERVER['DOCUMENT_ROOT'] . "/admin/MEDIA/document/";;
	...
	if(isset($_POST['nomFichier'])) {
		...
		if($isLien == 0){
			$lien = 'http://www.compotedeprod.com/admin/MEDIA/document/' . $nomFichierLien;
		...
		$message = "<html>
		<head>
		  <title>[CDP] Nouveau document uploadé sur l'intranet</title>
		</head>
		<body>
		  <table>
		  	<tr><td></td></tr>

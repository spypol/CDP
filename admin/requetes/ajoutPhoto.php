<?php
	...
	$target_path = $_SERVER['DOCUMENT_ROOT'] . "/admin/MEDIA/album/";;
	...
	if(isset($_POST['nomFichier'])) {
		...
		$lien = 'http://www.compotedeprod.com/admin/MEDIA/album/' . $nomFichierLien;
		...
		$message = "<html>
		<head>
		  <title>[CDP] Nouveau zip de photos uploadé sur l'intranet</title>
		</head>
		<body>
		  <table>
		  	<tr><td></td></tr>
		...
		mail($destinataires,"[CDP] Nouveau zip de photos ajouté à l'intranet", $message, $headers);
	}
?>
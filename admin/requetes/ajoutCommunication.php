<?php
	...
	if(isset($_POST['nomFichier'])) {
		...
		$message = "<html>
		<head>
		  <title>[CDP] Nouveau document de communication uploadé sur l'intranet</title>
		</head>
		<body>
		  <table>
		  	<tr><td></td></tr>
		...
		mail($destinataires,"[CDP] Document de communication ajouté à l'intranet", $message, $headers);
	}
?>
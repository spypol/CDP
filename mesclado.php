<?php
    ...
    $toClient = $email; 
    $subjectClient = 'Demande de Tickets Mesclado Bonne Année !';
        ...
        <div class="main-container">
            <div class="main wrapper clearfix">
				...
				<div id="articles">
					...
					<article id="contact">
						<section id="branding">
                            <img src="img/logos/Mesclado-logo_solo_sansContour-2000x365.jpg" class="logo-entreprise"/>
							...
							<form method="post" action="mesclado">
